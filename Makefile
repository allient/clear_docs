...
add-dev-migration:
	docker compose -f docker-compose-dev.yml exec backend_cdocs alembic revision --autogenerate && \
	docker compose -f docker-compose-dev.yml exec backend_cdocs alembic upgrade head && \
